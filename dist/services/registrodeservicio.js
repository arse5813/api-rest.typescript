...
const registrodeservicio_1 = __importDefault(require("../models/registrodeservicio"));
const interTramo = (item) => __awaiter(void 0, void 0, void 0, function* () {
    const responseInsert = yield registrodeservicio_1.default.create(item);
    return responseInsert;
});
exports.interTramo = interTramo;
const getTramos = () => __awaiter(void 0, void 0, void 0, function* () {
    const responseIntem = yield registrodeservicio_1.default.find({});
    return responseIntem;
});
exports.getTramos = getTramos;
const getTramo = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const responseIntem = yield registrodeservicio_1.default.findOne({ _id: id });
    return responseIntem;
});
exports.getTramo = getTramo;
const updateTramo = (id, data) => __awaiter(void 0, void 0, void 0, function* () {
    const responseIntem = yield registrodeservicio_1.default.findOneAndUpdate({ _id: id }, data, {
        new: true
    });
    return responseIntem;
});
...
const deleteTramo = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const responseIntem = yield registrodeservicio_1.default.findOneAndRemove({ _id: id });
    return responseIntem;
});
